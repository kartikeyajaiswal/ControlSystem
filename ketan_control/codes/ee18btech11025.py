...
plt.savefig('./fig/ee18btech11025/nyquist.pdf')
plt.savefig('./fig/ee18btech11025/nyquist.eps') #if using termux
subprocess.run(shlex.split("termux-open ./figs/ee18btech11025/nyquist.pdf"))

p, z = control.pzmap(G); #pole-zero plot
print('poles:', p)
print('zeros:', z)
plt.savefig('./figure/ee18bteh11025/polezero.pdf')
plt.savefig('./figure/ee18bteh11025/polezero.eps') #if using termux
